...
export default function UserLogin() {
    ...
    const handleGoogleLogin = async (credentialResponse: CredentialResponse) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/auth/user/google-login`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-card rounded-2xl shadow-xl border border-border p-8">
                        <div className="text-center mb-6">
                            <h2 className="text-2xl font-black text-foreground mb-2">Faculty Login</h2>
                            <p className="text-muted-foreground text-sm">Enter your credentials to order food</p>
                        </div>
