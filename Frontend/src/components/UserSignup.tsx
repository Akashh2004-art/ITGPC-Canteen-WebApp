...
import { Eye, EyeOff, User, Phone, Lock, LockKeyhole, ArrowRight, GraduationCap } from 'lucide-react';
...
export default function UserSignup() {
    ...
    const handleGoogleSignup = async (credentialResponse: CredentialResponse) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/auth/user/google-signup`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                ...
                <div className="max-w-xl w-full mx-auto px-6 py-12 lg:px-16 lg:py-12">
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <Button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-6 mt-4 group"
                        >
                            {isLoading ? (
                    ...
                    <p className="lg:hidden text-center text-xs text-muted-foreground mt-8">
                        © 2024 Itahar Government Polytechnic. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
